...
instance Core.ToHeaders GetWorkUnits where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "Content-Type"
...
instance Core.ToJSON GetWorkUnits where
  toJSON GetWorkUnits' {..} =
    Core.object
      ( Prelude.catMaybes
...
instance Core.ToPath GetWorkUnits where
  toPath = Prelude.const "/GetWorkUnits"

instance Core.ToQuery GetWorkUnits where
