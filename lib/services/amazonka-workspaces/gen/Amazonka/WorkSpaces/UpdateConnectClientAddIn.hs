...
instance Core.AWSService UpdateConnectClientAddIn where
...
instance Core.ToHeaders UpdateConnectClientAddIn where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Core.=# ( "WorkspacesService.UpdateConnectClientAddIn" ::
                          Prelude.ByteString
                      ),
            "Content-Type"
...
instance Core.ToJSON UpdateConnectClientAddIn where
...
instance Core.ToPath UpdateConnectClientAddIn where
  toPath = Prelude.const "/"

instance Core.ToQuery UpdateConnectClientAddIn where
